...
<<<<<<< HEAD
    ...
    <div class="flex gap-3">
        <a href="<?= BASEURL; ?>/blt/laporan/<?= $data['id_program']; ?>" class="px-4 py-2 bg-amber-50 text-amber-600 rounded-lg text-sm font-bold hover:bg-amber-100 transition flex items-center">
            <i class="fas fa-file-alt mr-2"></i> Laporan Transparansi
        </a>
        <a href="<?= BASEURL; ?>/blt/admin" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200 flex items-center">
