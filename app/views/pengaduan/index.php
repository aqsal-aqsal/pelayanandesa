...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-[32px] shadow-sm border border-gray-100 overflow-hidden">
        <div class="bg-blue-600 px-10 py-8">
            <h2 class="text-2xl font-black text-white">Kirim Pengaduan Masyarakat</h2>
            <p class="text-blue-100 text-sm mt-1">Sampaikan keluhan atau aspirasi Anda secara aman dan cepat.</p>
        </div>
        
        <form action="<?= BASEURL; ?>/pengaduan/kirim" method="POST" enctype="multipart/form-data" class="p-10 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    ...
                    <input type="text" name="judul_aduan" required class="block w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" placeholder="Apa yang ingin Anda laporkan?">
                </div>
                <div class="space-y-2">
            ...
            <div class="space-y-2">
                ...
                <textarea name="isi_aduan" rows="5" required class="block w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" placeholder="Ceritakan detail kejadian atau keluhan Anda secara lengkap..."></textarea>
            </div>
            ...
            <div class="space-y-2">
                ...
                <p class="text-[10px] text-gray-400 italic">Maksimal ukuran file 2MB (JPG, PNG, PDF)</p>
            </div>

            <div class="pt-6 flex justify-end space-x-4">
                <a href="<?= BASEURL; ?>/dashboard" class="px-8 py-4 text-sm font-bold text-gray-500 hover:text-gray-700 transition">Batal</a>
