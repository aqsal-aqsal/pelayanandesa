...
<body>
    ...
    <table class="report-table">
        ...
        <tbody>
            <?php $no = 1; foreach($data['informasi'] as $i): ?>
                <tr>
                    <td class="center"><?= $no++; ?></td>
                    <td class="center"><?= date('d/m/Y', strtotime($i['tgl_publikasi'])); ?></td>
                    <td style="font-weight: 700;"><?= htmlspecialchars((string)($i['judul'] ?? '')); ?></td>
                    <td><?= htmlspecialchars((string)($i['nama_petugas'] ?? '')); ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
