        ...
        <tbody>
            <?php $no = 1; foreach($data['programs'] as $p): ?>
                <tr>
                    ...
                    <td style="font-weight: 700;"><?= htmlspecialchars((string)($p['nama_program'] ?? '')); ?></td>
                    <td><?= htmlspecialchars((string)($p['sumber_dana'] ?? '')); ?></td>
                    <td class="center"><?= htmlspecialchars((string)($p['periode'] ?? '')); ?></td>
                    <td class="center"><?= $p['kuota_penerima'] ?? 0; ?></td>
