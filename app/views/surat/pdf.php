...
<head>
    ...
    <style>
        ...
        .header-text .district-name { font-weight: 700; font-size: 12pt; color: #334155; }
...
<body>
    ...
    <div class="header">
        ...
        <?php else: ?>
            <img src="<?= 'data:image/png;base64,' . base64_encode(file_get_contents($rootPath . '/public/assets/img/logokabbanjar.png')); ?>" class="logo-img" alt="Logo">
        <?php endif; ?>
